use crate::webcore::value::{Reference, ConversionError};
use crate::webcore::try_from::{TryFrom, TryInto};
use crate::webcore::value::{Undefined, Value};
use crate::webapi::html_elements::{CanvasElement, ImageElement};
use crate::webapi::html_element::IHtmlElement;
use crate::webapi::dom_exception::{SyntaxError, IndexSizeError, InvalidStateError, SecurityError, NotSupportedError};
...
impl TryFrom<Value> for CanvasStyle {
    ...
    fn try_from(value: Value) -> Result<Self, Self::Error> {
        ...
        Err(crate::webcore::value::ConversionError::type_mismatch( &value, "String, CanvasGradient or CanvasPattern".into() ))
    }
}
