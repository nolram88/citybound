...
impl<X: SampleUniform> From<crate::core::ops::Range<X>> for Uniform<X> {
...
mod tests {
    use crate::Rng;
    use crate::distributions::uniform::{Uniform, UniformSampler, UniformFloat, SampleUniform};
        ...
        macro_rules! t {
            ($($ty:ident),*) => {{
                $(
                   let v: &[($ty, $ty)] = &[(0, 10),
                                            (10, 127),
                                            (crate::core::$ty::MIN, crate::core::$ty::MAX)];
