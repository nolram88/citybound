...
#[cfg(feature="std")] #[doc(hidden)] pub use crate::rngs::adapter::read;
#[doc(hidden)] pub use crate::rngs::adapter::ReseedingRng;

#[allow(deprecated)]
#[cfg(feature="std")] #[doc(hidden)] pub use crate::rngs::EntropyRng;
...
#[doc(hidden)]
pub use crate::rngs::OsRng;

#[doc(hidden)] pub use crate::prng::{ChaChaRng, IsaacRng, Isaac64Rng, XorShiftRng};
#[doc(hidden)] pub use crate::rngs::StdRng;


#[allow(deprecated)]
#[doc(hidden)]
pub mod jitter {
    pub use crate::rngs::{JitterRng, TimerError};
}
#[allow(deprecated)]
#[cfg(all(feature="std",
          any(target_os = "linux", target_os = "android",
...
pub mod chacha {
    ...
    pub use crate::prng::ChaChaRng;
}
#[doc(hidden)]
pub mod isaac {
    //! The ISAAC random number generator.
    pub use crate::prng::{IsaacRng, Isaac64Rng};
}

#[cfg(feature="std")] #[doc(hidden)] pub use crate::rngs::ThreadRng;

////////////////////////////////////////////////////////////////////////////////


use crate::core::{marker, mem, slice};
