...
#[deprecated(since="0.5.0", note="use uniform instead")]
pub mod range {
    pub use crate::distributions::uniform::Uniform as Range;
    pub use crate::distributions::uniform::SampleUniform as SampleRange;
}

#[allow(deprecated)]
mod impls {
    use crate::Rng;
    use crate::distributions::{Distribution, Sample, IndependentSample,
            WeightedChoice};
    #[cfg(feature="std")]
    use crate::distributions::exponential::Exp;
    #[cfg(feature="std")]
    use crate::distributions::gamma::{Gamma, ChiSquared, FisherF, StudentT};
    #[cfg(feature="std")]
    use crate::distributions::normal::{Normal, LogNormal};
    use crate::distributions::range::{Range, SampleRange};
...
#[allow(deprecated)]
impl<T> crate::Rand for T where Standard: Distribution<T> {
...
mod tests {
    ...
    fn test_backwards_compat_sample() {
        ...
        assert_eq!(sampler.sample(&mut crate::test::rng(233)), 293);
        assert_eq!(sampler.ind_sample(&mut crate::test::rng(234)), 293);
    }
    
    #[cfg(feature="std")]
    #[test] #[allow(deprecated)]
    fn test_backwards_compat_exp() {
        use crate::distributions::{IndependentSample, Exp};
        let sampler = Exp::new(1.0);
        sampler.ind_sample(&mut crate::test::rng(235));
    }
