...
impl<T> crate::core::convert::AsRef<[T]> for IsaacArray<T> {
    #[inline(always)]
    fn as_ref(&self) -> &[T] {
        &self.inner[..]
    }
...
impl<T> crate::core::convert::AsMut<[T]> for IsaacArray<T> {
    #[inline(always)]
...
impl<T> crate::core::ops::Deref for IsaacArray<T> {
...
impl<T> crate::core::ops::DerefMut for IsaacArray<T> {
    #[inline(always)]
...
impl<T> crate::core::default::Default for IsaacArray<T> where T: Copy + Default {
